 ...
 */
 class Currency extends CI_Controller {
 	...
 	function currency_ajax()
 	{
        ...
        if(!empty($search))
        { 
            $like = "WHERE (cpm_currency.currency_name LIKE '%".$search."%' OR cpm_currency.currency_symbol LIKE '%".$search."%' OR cpm_currency.type LIKE '%".$search."%' OR cpm_currency.coin_type LIKE '%".$search."%')"; 
        }
        
        $query = "SELECT * FROM `cpm_currency` ".$like." ORDER BY id ASC LIMIT ".$start.",".$length;
