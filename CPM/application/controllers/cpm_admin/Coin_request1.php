...
class Coin_request extends CI_Controller 
{
	...
	function index() 
	{
		...
		$data['coin_request'] 		= $this->common_model->getJoinedTableData('add_coin as a',$hisjoins,'','a.*, b.cpm_username as username','','','',$urisegment,$perpage,array('a.coin_id', 'DESC'));
	...
	function view($id) 
	{
		...
		$isValid 	= $this->common_model->getJoinedTableData('add_coin as a',$hisjoins,$hiswhere,'a.*, b.cpm_username as username');
	...
	function coin_request_ajax()
	{
		...
		$coin_requests = $this->db->get("cpm_add_coin");
