                    ...
                    <div class="col-xl-12">
                        <nav class="navbar navbar-expand-lg navbar-light px-0 justify-content-between">
                           ...
                           <div id="header-sroll" class="theme-main-menu theme-menu-two ">  
                             <div class="logo"> <a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php  echo $sitelogo = $site_common['site_settings']->site_logo;   ?>" alt=""></a></div>
                                ...
                                <?php } ?>
                                          ...
                                          <!--       <li class="nav-item  position-relative">
                                                    <a class="nav-link " href="#" data-toggle="dropdown">News</a>
...
<?php } else{?>
                                        <div class="user" data-toggle="dropdown">
                                            <span class="thumb"><img class="me-3 rounded-circle me-0 me-sm-3 pro_img"
...
<?php }?>
 ...
 -->   
                    ...
                    <span id="min_valid" style="color:red;"> </span>
                          ...
                          <input type="submit" name="submit"  class="btn radius-50 th-bg " style="padding: 15px; height: 54px; background-color:#673bb7;margin-left: 90px!important;" id="submit" value="Buy Now"/>
                                 <?php echo form_close(); ?>
                      </div>
  ...
  //  var test = $('#amount-two').val();
    ...
    var ans = type.split ("_");
     ...
     var sec = second.split("_");
      ...
      document.getElementById("currenct_first_coin").innerHTML = ans[0]; 
      document.getElementById("currenct_second_coin").innerHTML = second;   
      // alert(ans[0]);
      // alert(second);
  $.getJSON('https://min-api.cryptocompare.com/data/pricemulti?fsyms='+ans[0]+'&tsyms='+second, function(data) {
$.each(data, function (cur, rate) {
obj = Object.entries(rate);
current = obj[0][1];
