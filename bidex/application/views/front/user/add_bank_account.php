                    ...
                    <div class="col-xl-5 col-md-6">
                        <div class="auth-form card">
                            ...
                            <div class="card-body">
                                    ...
                                    <?php $action = front_url() . 'add_bank_details';
                    $attributes=array('id'=>'add_bank_details','class'=>'identity-upload','autocomplete'=>"off");
                      echo form_open_multipart($action,$attributes); 
                      ?>
                                    <div class="row">
                                        <div class="mb-3 col-xl-12">
                                            <label class="form-label">Account Number </label>
                                            <input type="number" name="bank_account_number" id="bank_account_number" class="form-control" placeholder="**********">
                                        </div>
                                        <div class="mb-3 col-xl-12">
                                            <label class="form-label">IFSC Code </label>
                                            <input type="text" name="ifsc_code" id="ifsc_code" class="form-control" placeholder="**********">
                                        </div>
                                        <div class="mb-3 col-xl-12">
                                        ...
                                        <div class="mb-3 col-xl-12">
                                            ...
                                            <div class="file-upload-wrapper" data-text="Bank statement.pdf/jpg">
                                                <input name="bankscreenshot" type="file" class="file-upload-field">
                                            </div>
                                        </div>
