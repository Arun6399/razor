	...
	<body>
		<div class="main-page-wrapper">
			...
			<div id="header-sroll" class="theme-main-menu theme-menu-two ">
				<div class="logo"><a href="<?php echo base_url();?>"><img src="<?php echo $sitelogo;?>" alt="" style="margin-top: 7px;"></a></div>
...
<?php } ?>
                                        <div class="dropdown-menu dropdown-menu-end hom_use" style="margin-left: -120px; margin-top: 30px;">
