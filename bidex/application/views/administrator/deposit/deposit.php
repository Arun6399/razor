		...
		?>
			...
			<div class="row">
				...
				?>
								...
								<?php echo getUserDetails($deposit->user_id,'bidex_username'); ?>
                                </div>
                                </div>
                                <div class="form-group">
                                ...
                                <?php if($deposit->status=='Pending' && $deposit->payment_method=='Bankwire'){
