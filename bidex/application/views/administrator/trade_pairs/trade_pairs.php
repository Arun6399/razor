                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-2">
										<input type="text" name="bot_min_amount" id="bot_min_amount" class="form-control" value="" oninput="process(this)"/>
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_max_amount" id="bot_max_amount" class="form-control" value="" oninput="process(this)"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
										<input type="text" name="bot_minprice_per" id="bot_minprice_per" class="form-control" value="" oninput="process(this)"/>
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_maxprice_per" id="bot_maxprice_per" class="form-control" value="" oninput="process(this)"/ >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2">
										<input type="text" name="bot_time_min" id="bot_time_min" class="form-control" value="" oninput="process(this)"/>
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_time_max" id="bot_time_max" class="form-control" value="" oninput="process(this)"/>
                                        </div>
                                    </div>
                                   ...
                                   <div class="form-group">
									...
									<div class="form-group">
										...
										<select data-live-search="true" id="to_name" name="to_name" class="selectpicker form-control" placeholder="Pair Name">
											<!-- <select class="form-control" placeholder="Pair Name" id="to_name" name="to_name" onchange="change_to_symbol(this.value)"> -->
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Random Amount</label>
                                        <div class="col-md-2">
										<input type="text" name="bot_min_amount" id="bot_min_amount" class="form-control" value="<?php echo $pair->bot_min_amount; ?>" oninput="process(this)"/>
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_max_amount" id="bot_max_amount" class="form-control" value="<?php echo $pair->bot_max_amount; ?>" oninput="process(this)"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Random price % range</label>
                                        <div class="col-md-2">
										<input type="text" name="bot_minprice_per" id="bot_minprice_per" class="form-control" value="<?php echo $pair->bot_minprice_per; ?>" oninput="process(this)"/>
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_maxprice_per" id="bot_maxprice_per" class="form-control" value="<?php echo $pair->bot_maxprice_per; ?>" oninput="process(this)"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Random time interval seconds</label>
                                        <div class="col-md-2">
										<input type="text" name="bot_time_min" id="bot_time_min" class="form-control" value="<?php echo $pair->bot_time_min; ?>" oninput="process(this)"/>
                                        </div>
                                        <div class="col-md-2">
										<input type="text" name="bot_time_max" id="bot_time_max" class="form-control" value="<?php echo $pair->bot_time_max; ?>" oninput="process(this)"/>
                                        </div>
                                    </div>
	...
	<script>
	 ...
	 // alert(admin_url);
	  ...
	  function changePair() {
	  	...
	  	from = document.getElementById("from_name").value;
	  	to = document.getElementById("to_name").value;
	  	if(from!='' && to!='')
		  {
		  	//alert(from+'---'+to); return false;
			 $.ajax({
					url: '<?php echo admin_url();?>'+"trade_pairs/get_to_symbol", 
					type: "POST",             
					data: 'from_symbol='+from+'&to_symbol='+to,
					//cache: false,             
					processData: true,      
