...
<!-- begin #content -->
		...
		?>
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Fiat Management <!--<small>header small text goes here...</small>--></h1>
				...
				<div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Fiat Management</h4>
                        </div>
					...
					<?php if($view=='view_all'){ ?>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="table-responsive">
                            	<div id="datas-table_filter" class="dataTables_filter"><label>Search:<input type="search" id="myInput" class="" placeholder="" aria-controls="datas-table"></label></div>
        ...
        <div class="panel-body">
                        <div class="clearfix">
                            ...
                            <div class="table-responsive">
                            	<div id="datas-table_filter" class="dataTables_filter"><label>Search:<input type="search" id="myInputs" class="" placeholder="" aria-controls="datas-table"></label></div>
                                <table id="datas-crypto" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                        <th class="text-center">S.No</th>
                                        <th class="text-center">Email Address</th>
                             ...
                             <fieldset>
                                    ...
                                    <div class="form-group">
										...
										<select data-placeholder="User Name..." class="chosen-select" multiple style="width:350px; height: 200px;" tabindex="4" id="user_id" name="user_id">
											...
											<option value="<?php echo $user_details->id;?>"><?php echo $user_details->bidex_username;?></option>
											<?php } ?>
											</select>
											</div>
                                        </div>
	            ...
	            {
	              $account_no = get_admin_bank_details($deposit->bank_id);
	              ...
	              else
	              {
	              	...
	              	$country = get_countryname($account_no->bank_country);
				...
				?>
                               ...
                               <!--  <div class="form-group">
                                ...
                                <?php if($deposit->status=='Pending' && $deposit->payment_method=='bank'){
...
$(document).ready(function() {
    $('#datas-table').DataTable( {
        ...
        "searching": false,
        "ordering" : false,
        "ajax": admin_url+"fiat_transactions/deposit_ajax"
    });

    $("#myInput").on("keyup", function() {
    var value = $(this).val().toLowerCase();
    $("#datas-table tbody tr").filter(function() {
      $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
    });
  });

       $('#datas-crypto').DataTable( {
        "responsive" : true,
        "processing" : true,
        "pageLength" : 10,
        "serverSide": true,
        ...
        "searching": false,
        "ordering" : false,
        "ajax": admin_url+"fiat_transactions/deposit_ajaxcrypto"
    });

    $("#myInputs").on("keyup", function() {
    var value = $(this).val().toLowerCase();
    $("#datas-crypto tbody tr").filter(function() {
      $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
    });
  });
        });
