...
<!-- begin #content -->
		...
		?>
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Crypto Management <!--<small>header small text goes here...</small>--></h1>
			...
			<div class="row">
				<div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Crypto Management</h4>
                        </div>
				...
				?>
                                ...
                                <div class="col-md-8 control-label text-left">
								<?php echo $deposit->user_id.'#'.$deposit->datetime; ?>
                                </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                <label class="col-md-2 control-label"><?php echo $deposit->type?> On</label>
                                <div class="col-md-8 control-label text-left">
								<?php echo date("d-m-Y h:i a", $deposit->datetime); ?>
                                </div>
                            	</div>

                                <div class="form-group">
                                <label class="col-md-2 control-label">Crypto Address</label>
                                <div class="col-md-8 control-label text-left">
...
$('#datas-crypto').DataTable( {
        ...
        "searching": false,
        "ordering" : false,
        "ajax": admin_url+"crypto_transactions/deposit_ajaxcrypto"
    });
