...
<script src="https://cdnjs.cloudflare.com/ajax/libs/lightbox2/2.11.1/js/lightbox-plus-jquery.min.js"></script>
        ...
        <!-- <div>KYC<?php echo $count_result; ?></div> -->
            ...
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header"><?php if($this->uri->segment(3)=='') { echo "Activated Users"; } else if($this->uri->segment(3)=='unverified_users') { echo "De-Activated Users"; } else if ($this->uri->segment(3)=='verification') { echo 'Users KYC Verification'; } else if($this->uri->segment(3)=='payment') { echo 'Users Payment'; } else if($this->uri->segment(3)=='company_verification') { echo 'Users Company Verification'; } ?> Management  <!--<small>header small text goes here...</small>--></h1>
            <!-- end page-header -->
            <!-- begin row -->
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><?php if($this->uri->segment(3)=='') { echo "Activated Users"; } else if($this->uri->segment(3)=='unverified_users') { echo "De-Activated Users"; } else if ($this->uri->segment(3)=='verification') { echo 'Users KYC Verification'; } else if($this->uri->segment(3)=='payment') { echo 'Users Payment'; } else if($this->uri->segment(3)=='company_verification') { echo 'Users Company Verification'; } ?> Management</h4>
                        </div>
                                ...
                                <table id="kyc-data" class="table table-striped table-bordered" id="view_all">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Level-2 Status</th>
                ...
                echo form_open_multipart($action,$attributes); ?>
                               ...
                               <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                        <label class="col-md-2 control-label">Profile pictures</label>
                                        <div class="col-md-8 control-label text-left">
                                        <span class="u_img"><img src="<?php if($users->profile_picture==''){ echo base_url() . 'assets/front/img/user.png'; } else { echo $users->profile_picture; }?>" > </span>&nbsp;&nbsp;&nbsp;
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                        <label class="col-md-2 control-label">Street Address 2</label>
                                        <div class="col-md-8 control-label text-left">
                                        <?php
                                            echo ($users->street_address_2!='')?$users->street_address_2:'-'; ?>
                                        </div>
                                </div>
                                <div class="form-group">
                         ...
                         <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Front Id Proof</label>
                                ...
                                <br>
                                 <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Back ID Proof</label>
                                        ...
                                        <label class="label label-danger"> <?php echo $verify_status1; ?></label>
                                        <br>
                                         <?php } else { ?>
                          ...
                          <!--        <div class="form-group">
                               ...
                               <!--  <div class="form-group">
                                ...
                                <br>
                                 ...
                                 <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Front Address Proof</label>
                                        ...
                                        <label class="label label-danger"> <?php echo $verify_status2; ?></label>
                                        <br>
                                        <?php } else { ?>
                                        <label class="label label-info">
                                ...
                                <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Back Address Proof</label>
                                        ...
                                        else if($users->photo_4_status==0)
                                        {
                                            $verify_status2 = "Not uploaded";
                                        }?>
                                        <?php if($verify_status2=='Pending' || $verify_status2=='Verified') { ?>
                                        <span class="u_img">
                                        <img height="150" width="150" src="<?php echo $users->photo_id_4; ?>" > 
                                        </span>&nbsp;
                                        <?php } ?>
                                        <?php if($verify_status2=='Pending' || $verify_status2=='Rejected') { ?>
                                        ...
                                        <br>
                                        <?php if($users->photo_4_status==1 && $users->photo_id_4 !=''){ ?>
                                        <a data-lightbox="image-1" href="<?php echo $users->photo_id_4; ?>" class="btn btn-sm btn-primary"  download = "false" target="_blank" 
                                        style="margin-top:45px;">View</a>
                                        <?php if($users->photo_4_status==1 && $users->photo_id_4 !=''){
                                        $url3 = admin_url().'users/verify_photo4_status/'.$users->id.'/3';  ?>
                                        <a class="btn btn-sm btn-primary btn-success" href="<?php echo $url3; ?>" style="margin-top:45px;">Verify</a>
                                        <a class="btn btn-sm btn-primary btn-danger" href="#myModal5"  data-toggle="modal" style='margin-top:45px;'>Reject</a>
                                        <?php } } ?>
                                        </div>
                                </div>

                                <div class="form-group row">
                                        <label class="col-lg-2 col-form-label">Selfie Proof</label>
                                        
                                        <div class="col-lg-4">
                                        <?php if($users->photo_5_status==3)
                                        {
                                            $verify_status2 = "Verified";
                                            
                                        }
                                        else if($users->photo_5_status==2)
                                        {

                                            $verify_status2 = "Rejected";
                                            
                                        } 
                                        else if($users->photo_5_status==1)
                                        {
                                            if($users->photo_id_5 !='')
                                            {
                                            $verify_status2 = "Pending";
                                        ...
                                        else if($users->photo_5_status==0)
                                        {
                                            $verify_status2 = "Not uploaded";
                                        }?>
                                        <?php if($verify_status2=='Pending' || $verify_status2=='Verified') { ?>
                                        <span class="u_img">
                                        <img height="150" width="150" src="<?php echo $users->photo_id_5; ?>" > 
                                        </span>&nbsp;
                                        <?php } ?>
                                        <?php if($verify_status2=='Pending' || $verify_status2=='Rejected') { ?>
                                        <label class="label label-danger"> <?php echo $verify_status2; ?></label><?php } else { ?>
 ...
 <label class="col-lg-2 col-form-label"></label>
                                        ...
                                        <br>
                                        <?php if($users->photo_5_status==1 && $users->photo_id_5 !=''){ ?>
                                        <a data-lightbox="image-1" href="<?php echo $users->photo_id_5; ?>" class="btn btn-sm btn-primary"  download = "false" target="_blank" 
                                        style="margin-top:45px;">View</a>
                                        <?php if($users->photo_5_status==1 && $users->photo_id_5 !=''){
                                        $url3 = admin_url().'users/verify_photo5_status/'.$users->id.'/3';  ?>
                                        <a class="btn btn-sm btn-primary btn-success" href="<?php echo $url3; ?>" style="margin-top:45px;">Verify</a>
                                        <a class="btn btn-sm btn-primary btn-danger" href="#myModal6"  data-toggle="modal" style='margin-top:45px;'>Reject</a>
                                        <?php } } ?>
                                        </div>
                                </div>
                                </fieldset>
...
<div id="myModal" class="modal fade">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="paddingT15 paddingB15"> 
             <center><?php echo form_open(admin_url().'users/verify_photo4_reject/'.$users->id.'/2'); ?>
            <textarea name="reject_mail_content" class="form-control" required></textarea>
            <br/>
            <button class="btn btn-small btn-danger" style='margin-left:20px;'>REJECT</button>
            <?php echo form_close(); ?></center>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="paddingT15 paddingB15"> 
             <center><?php echo form_open(admin_url().'users/verify_photo5_reject/'.$users->id.'/2'); ?>
            <textarea name="reject_mail_content" class="form-control" required></textarea>
            <br/>
            <button class="btn btn-small btn-danger" style='margin-left:20px;'>REJECT</button>
            <?php echo form_close(); ?></center>
