...
<div id="content" class="content">
	...
	?>
		...
		<!-- end breadcrumb -->
		<!-- begin page-header -->
		<h1 class="page-header">Swap <!--<small>header small text goes here...</small>--></h1>
                            		...
                            		<table id="datas-table" class="table table-striped table-bordered">
			                            <thead>
			                                <tr>
												...
												<th class="text-center">From Coin </th>
												<th class="text-center">From Coin Amount </th>
												<th class="text-center">To Coin</th>
												<th class="text-center">To Coin Amount</th>
