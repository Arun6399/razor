            ...
            <div class="col-md-12">
                  <div class="panel panel-inverse">
                        ...
                        <!--h4>Select Fiat Currency</h4>
                              ...
                              <fieldset>
                                    <?php if(!empty($cu)) { 
                                            // if($cu->currency_symbol=='BTC' && $cu->currency_symbol=='ETH')
                                            //  {
                                          foreach($cu as $cus) { 
                                                ...
                                                $type="crypto";
                                                ?>
                                                <a href="<?php echo admin_url() . 'admin/super_coinprofit/'.$cus->id.'/crypto'; ?>"><font class="<?php if($currency_symbol==$cus->currency_symbol){ echo 'btn btn-small btn-danger'; } else{ echo 'btn btn-small btn-success'; } ?>" style="margin-bottom: 10px;"><?php echo $cus->currency_symbol; ?></font></a>
                                    ...
                                    <div class="panel-body">
                                          <div class="table-responsive">
                                                ...
                                                if ($weekly) {
                                                      ...
                                                      // print_r($weekly);
                                                      $i = 1;
                                                      foreach($weekly as $result1) {
                                                            // $bonus=$result1->total+$result1->bonus;
                                                            if($result1->week_number!='') {

                                                            echo '<tr>';
                                                            echo '<td>' . $i . '</td>';
                                                            echo '<td>' . $result1->week_number . '</td>';
                                                            echo '<td>' . $result1->week_year . '</td>';
                                                            echo '<td>' . $result1->weekly_profit. '</td>';
                                                            echo '<td>'. '<a href="' . admin_url() . 'admin/super_form/' . $result1->No . '" data-placement="top" data-toggle="popover" data-content="Edit this Bank details." class="poper"><i class="fa fa-pencil text-primary"></i></a>&nbsp;&nbsp;&nbsp;' .'</td>';
                                                            echo '</tr>';
                                                            $i++;
                                                      }  
                                                }
                                                ...
                                                if ($monthly) {
                                                    ...
                                                    // print_r($monthly);
                                                      ...
                                                      foreach($monthly as $result2) {
                                                            ...
                                                            echo '<tr>';
                                                            echo '<td>' . $i . '</td>';
                                                            echo '<td>' . $result2->month . '</td>';
                                                            echo '<td>' . $result2->monthly_year . '</td>';
                                                            echo '<td>' . $result2->monthly_profit . '</td>';
                                                            echo '<td>'. '<a href="' . admin_url() . 'admin/super_form/' . $result2->No . '" data-placement="top" data-toggle="popover" data-content="Edit this Bank details." class="poper"><i class="fa fa-pencil text-primary"></i></a>&nbsp;&nbsp;&nbsp;' .'</td>';
                                                            echo '</tr>';
                                                            $i++;
                                                      }
                                    ...
                                    <div class="panel-body">
                                          <div class="table-responsive">
                                                ...
                                                if ($yearly) {
                                                      ...
                                                      $i = 1;
                                                      foreach($yearly as $result3) {

                                                            if($result3->yearly_year!='')
                                                            {
                                                            ...
                                                            echo '<tr>';
                                                            echo '<td>' . $i . '</td>';
                                                            echo '<td>' . $result3->yearly_year . '</td>';
                                                            echo '<td>' . $result3->yearly_profit . '</td>';
                                                           echo '<td>'. '<a href="' . admin_url() . 'admin/super_form/' . $result3->No . '" data-placement="top" data-toggle="popover" data-content="Edit this Bank details." class="poper"><i class="fa fa-pencil text-primary"></i></a>&nbsp;&nbsp;&nbsp;' .'</td>';
                                                            echo '</tr>';
                                                            $i++;
                                                      }
                                                            }
