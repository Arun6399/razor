		...
		<div class="col-md-12">
		  ...
		  ?>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-md-8">
											<?php echo $user_bankdetails->ifsc_code; ?>
		                                </div>
		                            </div>

		                            <div class="form-group">
		                                <label class="col-md-2 control-label">Bank Statement Screenshot</label>
		                                <div class="col-md-8">
		                                	<?php if($user_bankdetails->bank_statement==''){?>
		                                	<span class="u_img">
                                        	<img height="150" width="150" src="<?php echo base_url();?>assets/images/id.png" >
                                        </span>
<?php } else{?>
											<span class="u_img">
                                        	<img height="150" width="150" src="<?php echo $user_bankdetails->bank_statement; ?>" > 
                                        </span>
                                    <?php }?>
		                                </div>
		                            </div>
                            		...
                            		<!-- <div class="form-group">
		                                ...
		                                <div class="col-md-8 control-label text-left">
		                                	<?php 
		                                		...
		                                		echo $user_bankdetails->bank_country; 
		                                	?>
		                                </div>
                        			</div> -->
			                         <?php
