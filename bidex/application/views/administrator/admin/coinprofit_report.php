				...
				<div class="col-md-12">
                    <div class="panel panel-inverse">
                        ...
                        <h4>Select Currency</h4>
                                <fieldset>
                                  <?php $curArr = array('BTC','ETH');
                                  if(!empty($cu)) { 
                                  	foreach($cu as $cus) { 
                                  		if(in_array($cus->currency_symbol, $curArr)) {
                                  		$type="crypto";
                                  		?>
										<a href="<?php echo admin_url() . 'admin/coinprofit_report/'.$cus->id.'/crypto'; ?>"><font class="<?php if($currency_symbol==$cus->currency_symbol){ echo 'btn btn-small btn-danger'; } else{ echo 'btn btn-small btn-success'; } ?>" style="margin-bottom: 10px;"><?php echo $cus->currency_symbol; ?></font></a>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								if ($weekly->num_rows() > 0) {
									...
									$weekly_btc = array('0.210836','0.210836','0.210836','0.210836','0.210836','0.210836','0.12','0.158127','0.158127','0.105418','0.00564','0.01694','0.00847','0.0142','0.014395','0.00359875','0.0071975','0.00359875');
									
									$weekly_eth = array('0.590311','0.590311','0.590311','0.590311','0.590311','0.1212','0.2424','0.0606','0.0757','1.7649','0.052','0.0364','0.0291','0.0291','0.06265','0.0156625','0.031325','0.0156625');	
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="monthlydata">
									...
									if($currency_symbol == 'ETH'){
                                        ...
                                        echo '<tr><td>5</td><td>October</td><td>2022</td><td> 0.1466 </td></tr>';
                                        echo '<tr><td>6</td><td>November</td><td>2022</td><td> 0.19 </td></tr>';
                                        echo '<tr><td>7</td><td>December</td><td>2022</td><td> 0.1904 </td></tr>';
                                        echo '<tr><td>8</td><td>January</td><td>2023</td><td> 0.1449 </td></tr>';
                                        echo '<tr><td>9</td><td>February</td><td>2023</td><td> 0.2194 </td></tr>';
                                        echo '<tr><td>10</td><td>March</td><td>2023</td><td> 0.1253 </td></tr>';
                                        ...
                                        echo '<tr><td>5</td><td>October</td><td>2022</td><td> 0.04525 </td></tr>';
                                        echo '<tr><td>6</td><td>November</td><td>2022</td><td> 0.022 </td></tr>';
                                        echo '<tr><td>7</td><td>December</td><td>2022</td><td> 0.02083 </td></tr>';
                                        echo '<tr><td>8</td><td>January</td><td>2023</td><td> 0.04032 </td></tr>';
                                        echo '<tr><td>9</td><td>February</td><td>2023</td><td> 0.02536 </td></tr>';
                                        echo '<tr><td>10</td><td>March</td><td>2023</td><td> 0.02879 </td></tr>';
                                  }
