<!-- begin #content -->
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="password" name="paypal_username" class="form-control" value="<?php echo decryptIt($siteSettings->paypal_username); ?>" id="paypal_username" autocomplete="off" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Paypal Password:</label>
                                        <div class="col-md-4">
                                            <input type="password" name="paypal_password" class="form-control" value="<?php echo decryptIt($siteSettings->paypal_password); ?>" id="paypal_password" autocomplete="off" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Paypal Signature:</label>
                                        <div class="col-md-4">
                                            <input type="password" name="paypal_signature" class="form-control" value="<?php echo decryptIt($siteSettings->paypal_signature); ?>" id="paypal_password" autocomplete="off" required>
                                        </div>
                                    </div>
 ...
 -->
                                    <h4 style="text-align: center;">Referral Bonus</h4>
                                          <div class="form-group">
                                        <label class="col-md-4 control-label">Referral Bonus Type </label>
                                        <div class="col-md-4">
                                            <select data-live-search="true" class="selectpicker form-control" name="referral_bonus_type" id="referral_bonus_type">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Referral Bonus</label>
                                        <div class="col-md-4">
                                            <input type="text" name="referral_bonus" class="form-control" value="<?php echo $siteSettings->referral_bonus; ?>" id="referral_bonus" autocomplete="off" required >
                                        </div>
                                    </div>
                           ...
                           <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Coin profit setting</label>
                                        <div class="col-md-4">
                                            <div class="form-check-inline">
                                                <label class="customradio">
                                                    <span class="radiotextsty">Enable</span>
                                                    <input type="radio" name="coin_profit_setting" value="1" <?=(($siteSettings->coin_profit_setting==1)?'checked':'')?> >
                                                    <span class="checkmark"></span>
                                                </label> 
                                                <label class="customradio">
                                                    <span class="radiotextsty">Disable</span>
                                                    <input type="radio" name="coin_profit_setting" value="0" <?=(($siteSettings->coin_profit_setting==0)?'checked':'')?> >
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Coin profit report setting</label>
                                        <div class="col-md-4">
                                            <div class="form-check-inline">
                                                <label class="customradio">
                                                    <span class="radiotextsty">Enable</span>
                                                    <input type="radio" name="coinprofit_setting" value="1" <?=(($siteSettings->coinprofit_setting==1)?'checked':'')?> >
                                                    <span class="checkmark"></span>
                                                </label> 
                                                <label class="customradio">
                                                    <span class="radiotextsty">Disable</span>
                                                    <input type="radio" name="coinprofit_setting" value="0" <?=(($siteSettings->coinprofit_setting==0)?'checked':'')?> >
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
