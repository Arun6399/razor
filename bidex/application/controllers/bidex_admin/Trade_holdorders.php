...
$query ="SELECT a.*,d.coin_type, b.from_symbol_id as from_currency_id, b.to_symbol_id as to_currency_id, c.bidex_username as username, d.currency_symbol as from_currency_symbol, e.currency_symbol as to_currency_symbol FROM bidex_coin_order as a JOIN bidex_trade_pairs as b ON a.pair = b.id JOIN bidex_users as c ON a.userId = c.id JOIN bidex_currency as d ON b.from_symbol_id = d.id JOIN bidex_currency as e ON b.to_symbol_id = e.id WHERE a.Type = 'buy' AND a.orderDate='".$formdate."' ORDER BY a.tradetime DESC";


$countquery = $this->db->query("SELECT a.*,d.coin_type,d.coin_type, b.from_symbol_id as from_currency_id, b.to_symbol_id as to_currency_id, c.bidex_username as username, d.currency_symbol as from_currency_symbol, e.currency_symbol as to_currency_symbol FROM bidex_coin_order as a JOIN bidex_trade_pairs as b ON a.pair = b.id JOIN bidex_users as c ON a.userId = c.id JOIN bidex_currency as d ON b.from_symbol_id = d.id JOIN bidex_currency as e ON b.to_symbol_id = e.id WHERE a.Type = 'buy' AND a.orderDate='".$formdate."' ORDER BY a.tradetime DESC");
...
$countquery = $this->db->query("SELECT a.*,d.coin_type,d.coin_type, b.from_symbol_id as from_currency_id, b.to_symbol_id as to_currency_id, c.bidex_username as username, d.currency_symbol as from_currency_symbol, e.currency_symbol as to_currency_symbol
FROM bidex_coin_order as a
JOIN bidex_trade_pairs as b ON a.pair = b.id
JOIN bidex_users as c ON a.userId = c.id
JOIN bidex_currency as d ON b.from_symbol_id = d.id
