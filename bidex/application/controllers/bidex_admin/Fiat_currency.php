 ...
 */
 class Fiat_currency extends CI_Controller {
	...
	function add() {
		...
		$this->form_validation->set_rules('deposit_fees_type', 'Deposit Fees Type', 'required|xss_clean');
		$this->form_validation->set_rules('deposit_max_fees', 'Maximum Deposit Fees', 'required|xss_clean');
