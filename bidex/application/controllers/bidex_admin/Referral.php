 ...
 */
 class Referral extends CI_Controller {
    ...
    { 
        ...
        $query = "SELECT * FROM `bidex_transaction_history` ".$like." ORDER BY id DESC LIMIT ".$start.",".$length;
    ...
    else
    {
        ...
        $query = "SELECT * FROM `bidex_transaction_history` WHERE type='Referral' ORDER BY id DESC LIMIT ".$start.",".$length;

        $countquery = $this->db->query("SELECT * FROM `bidex_transaction_history` WHERE type='Referral'");
        $users_history = $this->db->query($query);
        $users_history_result = $users_history->result(); 
