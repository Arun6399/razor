 ...
 class News extends CI_Controller {
 	...
 	function news_ajax()
 	{
        ...
        { 
			...
			$query = "SELECT * FROM bidex_news ".$like." ORDER BY id DESC LIMIT ".$start.",".$length;
			$countquery = $this->db->query("SELECT * FROM bidex_news ".$like." ORDER BY id DESC");
        ...
        {
        	$query = 'SELECT * FROM bidex_news ORDER BY id LIMIT '.$start.','.$length;

        	$countquery = $this->db->query('SELECT * FROM bidex_news ORDER BY id DESC');
        	$users_history = $this->db->query($query);
            $users_history_result = $users_history->result(); 
            $num_rows = $countquery->num_rows();            
        }
