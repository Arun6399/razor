...
class Doge_wallet_model extends CI_Model {  
	/*
	...
	*/
	public function __construct() 
	{
		parent::__construct();	
		$tables = wallet_table();		
		$wallet_whr 	   = array('type'=>'doge','con_type'=>'rpc','status'=>'active');
	...
	//	print_r($wallet_row);
		if(!empty($wallet_row)){
			...
			// echo 'http://'.$wallet_username.':'.$wallet_password.'@'.$wallet_allow_ip.':'.$wallet_portnumber;
...
public function getblockcount()
	...
	*/
	...
	{
		return $this->wallet->getaccountaddress($user_email);
	}
	...
	*/
	public function getnewaddress($user_email = '')
	{
		...
		/*print_r($this->wallet->getnewaddress($user_email));
		exit;*/
	...
	*/
	...
	public function listalltransactions()
	{
		 // echo "test";
		 // exit();
        // print_r($this->wallet->listtransactions());
         // exit();
	...
	*/
	...
	public function sendfrom($from_account, $to_coin_address, $amount, $minconf, $comment ='no comment', $comment_to ='no to comment')
	{ 
		/*echo "BITCOIN WALLET";
		...
		echo $this->wallet->sendfrom($from_account,$to_coin_address,$amount);
		exit;
	...
	*/
	public function sendtoaddress($coin_address, $amount, $comment ='no comment')
	{
		...
		//echo '<pre>';
	//print_r($this->wallet->getbalance()); 
		//exit;
		/*$result = $this->wallet->sendtoaddress($coin_address,$amount,$comment);
		print_r($result);
		exit;*/
