...
//          exit();
			...
			switch ($method) {
				...
				if($coin_name=="ripple")
				{ 					
					$result = $this->$model_name->sendfrom($parameter['fromacc'],$parameter['toaddress'],$parameter['amount'],$parameter['tagid'],$parameter['tagid'],$parameter['secret'],$parameter['comment'],$parameter['comment_to']);
				}
				else
				{
