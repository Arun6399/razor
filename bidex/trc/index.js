...
var server = http.createServer(function(req, res) {
    ...
    req.on('end', function() {
        ...
        console.log(data);
        console.log("http://142.132.252.120:18099")
        if(data.method == "createaddress")
        {
            const tronWeb = new TronWeb({
              fullHost: 'http://142.132.252.120:18099',
           });
        ...
        else if(data.method == "tokentransfer")
        {
            ...
            const fullNode = new HttpProvider("http://142.132.252.120:18099");
            const solidityNode = new HttpProvider("http://142.132.252.120:18099");
            const eventServer = new HttpProvider("http://142.132.252.120:18099");
    ...
    else if(data.method == "ercbalance")
    {
        ...
        const web3 = new Web3('http://142.132.252.120:8585');
